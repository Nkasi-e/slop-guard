...
**Extension releases:** see root [`CHANGELOG.md`](./CHANGELOG.md) and [`extension/README.md`](./extension/README.md) for Marketplace-facing notes. Latest extension version in-repo: **0.0.6**.
